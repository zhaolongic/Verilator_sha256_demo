...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        __Vtemp19[0U] = ((IData)(0x5be0cd19U) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__h_out);
        __Vtemp19[1U] = ((IData)(0x1f83d9abU) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__g_out);
        __Vtemp19[2U] = ((IData)(0x9b05688cU) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__f_out);
        __Vtemp19[3U] = ((IData)(0x510e527fU) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__e_out);
        __Vtemp19[4U] = ((IData)(0xa54ff53aU) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__d_out);
        __Vtemp19[5U] = ((IData)(0x3c6ef372U) + vlSelf->top__DOT__sha__DOT__sha_top__DOT__c_out);
        __Vtemp19[6U] = (IData)((((QData)((IData)(((IData)(0x6a09e667U) 
                                                   + vlSelf->top__DOT__sha__DOT__sha_top__DOT__a_out))) 
                                  << 0x20U) | (QData)((IData)(
                                                              ((IData)(0xbb67ae85U) 
                                                               + vlSelf->top__DOT__sha__DOT__sha_top__DOT__b_out)))));
        __Vtemp19[7U] = (IData)(((((QData)((IData)(
                                                   ((IData)(0x6a09e667U) 
                                                    + vlSelf->top__DOT__sha__DOT__sha_top__DOT__a_out))) 
                                   << 0x20U) | (QData)((IData)(
                                                               ((IData)(0xbb67ae85U) 
                                                                + vlSelf->top__DOT__sha__DOT__sha_top__DOT__b_out)))) 
                                 >> 0x20U));
        tracep->chgWData(oldp+16,(__Vtemp19),256);
