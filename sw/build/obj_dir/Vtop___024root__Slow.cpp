...
void Vtop___024root___initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((0U != VL_TESTPLUSARGS_I("trace")))) {
        vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(10, Vtop__ConstPool__CONST_da02d5d7_0));
        vlSymsp->_traceDumpOpen();
        VL_WRITEF("[%0t] Tracing to verilator_test/sw/build/wave_logs/vlt_dump.vcd...\n\n",
