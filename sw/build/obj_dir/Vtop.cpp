...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , PWRITE_i{vlSymsp->TOP.PWRITE_i}
    , PSEL_i{vlSymsp->TOP.PSEL_i}
    , PENABLE_i{vlSymsp->TOP.PENABLE_i}
    , PREADY_o{vlSymsp->TOP.PREADY_o}
    , PSLVERR_o{vlSymsp->TOP.PSLVERR_o}
    , upio_in_i{vlSymsp->TOP.upio_in_i}
    , upio_out_o{vlSymsp->TOP.upio_out_o}
    , upio_dir_o{vlSymsp->TOP.upio_dir_o}
    , int_o{vlSymsp->TOP.int_o}
    , PADDR_i{vlSymsp->TOP.PADDR_i}
    , PWDATA_i{vlSymsp->TOP.PWDATA_i}
    , PRDATA_o{vlSymsp->TOP.PRDATA_o}
    , rootp{&(vlSymsp->TOP)}
{
}
...
static void _eval_initial_loop(Vtop__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("../../rtl/sha256/../../rtl/sha256/top.v", 11, "",
